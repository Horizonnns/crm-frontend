...
<template>
	<section
		class="w-full min-h-screen bg-header-gradient"
	>
		<h2
			class="font-bold text-2xl text-center border-b border-gray-500 bg-white p-5"
		>
			Front-office
		</h2>
		...
		<div class="px-4 mx-auto">
			<div class="flex flex-col mt-6 shadow-lg">
				...
				>
					...
					>
						<div
							class="p-2 space-y-4 bg-white overflow-hidden border border-gray-200 md:rounded-lg"
						>
							<div
							...
							>
								...
								<button
									type="submit"
									class="border rounded-md px-3 py-2 hover:bg-primary hover:text-white font-bold text-sm duration-200"
								>
									Создать заявку
								</button>
							</div>
							...
							>
								...
								>
									...
									>
										...
										<td
											class="px-4 py-4 text-sm whitespace-nowrap overflow-y-auto"
										>
											<h4
										...
										<td
											scope="row"
											class="pl-8 pr-4 py-4 whitespace-nowrap space-x-2"
										>
											<button
