												...
												>
													...
													>
														<div>
															<p>ФИО</p>
															<p
																class="bg-gray-100/60 px-2 py-1 rounded-full text-gray-500 text-sm font-normal"
															>
																{{
																	app.specialist_name
																}}
														...
														<div>
															<p>Лицевой счёт</p>
															<p
																class="bg-gray-100/60 px-2 py-1 w-fit rounded-full text-gray-500 text-sm font-normal"
															>
																{{
																	app.account_number
																}}
													...
													>
														...
														>
															<p>Специалист</p>
															<p
																class="bg-gray-100/60 text-gray-500 text-sm font-normal -mr-2 px-2 py-1 rounded-full"
															>
																{{
																	app.job_title
																}}
														...
														>
															...
															<p
																...
																class="text-center font-medium text-sm -mr-2 px-2 py-1 rounded-full"
															>
																{{ app.status }}
															</p>
														</div>
